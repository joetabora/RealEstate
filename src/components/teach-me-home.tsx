      ...
      <div className="mx-auto max-w-5xl">
        <header className="max-w-2xl">
          ...
          <p className="mt-4 max-w-xl text-base leading-7 text-muted">
            ...
            sittings through the 14-chapter course — Chapters 1–8 now
            (Agency through Title of Real Estate), then the rest.
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
          <article className="card p-6 sm:p-8">
            ...
            <p className="mt-3 text-sm leading-6 text-muted">
              ...
              Progress lists Chapters 1–8 concepts. Start session finishes each
