  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <p className="mt-4 max-w-2xl text-base leading-7 text-muted">
        Deterministic gates for generated content: source → structural → answer →
        ambiguity → WI-fact. Teach Me and Practice still use <span className="text-ink">active</span>{" "}
        only. Gates never invent Wisconsin cites.
      </p>
          ...
          <section className="card p-6 sm:p-8">
            ...
            {data.queue.length === 0 ? (
              <p className="mt-3 text-sm text-muted">
                ...
                New drafts enter as <code className="text-ink">generated</code>.
              </p>
            ) : (
