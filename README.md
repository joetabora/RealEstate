...
- Hand-authored Chapter 1–11 MCQs from seeded confusion pairs, with heading citations
...
Generated MCQs through validation gates, class-miss photo intake, tutor, math solver, exam simulator, embeddings, OpenAI, OCR, video, XP, authentication, questions for chapters 12–14 (same loop comes next).
