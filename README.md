...
This repository is **Phase 2**: foundation plus local ingestion of PUB725 and Chapter 1 notes into page-cited sections. Teach Me sessions are not built yet.
...
Open [http://localhost:3000](http://localhost:3000). Library is at [http://localhost:3000/library](http://localhost:3000/library).
...
Quizzes, tutor, math solver, exam simulator, embeddings, OpenAI, OCR, video, XP, authentication.
