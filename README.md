...
- Hand-authored Chapter 1–8 MCQs from seeded confusion pairs, with heading citations
...
Generated MCQs through validation gates, class-miss photo intake, tutor, math solver, exam simulator, embeddings, OpenAI, OCR, video, XP, authentication, questions for chapters 9–14 (same loop comes next).
